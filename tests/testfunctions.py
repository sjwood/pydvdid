...
@parameterized([
    ...
    param("Test size < 4Gb", "DVD_PATH/VIDEO_TS/VTS_02_0.VOB", 3812800233, "\xe9\xb6\x42\xe3")
])
...
@istest
@parameterized([
    param("Standard DVD file", "DVD_PATH/VIDEO_TS/VIDEO_TS.IFO", "VIDEO_TS.IFO", "VIDEO_TS.IFO\0"),
    param("Filename with Unicode euro char", u"\u20ac.txt", u"\u20ac.txt", "\xe2\x82\xac.txt\0")
])
